<html>
    ...
    <link rel="stylesheet" href="css/signupapp.css">
    </head>
    <body>
   <main>
           ...
           <section class="section-default">
               ...
               <div class="container">
                  <div class="row justify-content-center">
                       <div class="col-md-5">
                           <img class="avatar" alt="avatar" src="images/avatar(3).png">
                           <div class="card">                               
                           <div class="card-body py-md-4">
              <form class="form-signup" action="includes/signupapp.inc.php"method="post">
